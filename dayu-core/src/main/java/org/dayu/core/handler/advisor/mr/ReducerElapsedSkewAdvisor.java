 ...
 */
@Component
@ConfigurationProperties("org.dayu.core.handler.advisor.mr.reducer-elapsed-skew-advisor")
public class ReducerElapsedSkewAdvisor extends AbstractMRSkewAdvisor {
